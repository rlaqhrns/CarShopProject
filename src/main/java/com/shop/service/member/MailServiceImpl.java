...
public class MailServiceImpl implements MailService{
	...
	public void sendMail(String mail) throws MessagingException {
			...
			helper.setTo(mail);
			helper.setSubject("저리카shop 비밀번호 재설정메일222222");
			String a = "<!DOCTYPE html>\r\n" + 
					...
					"      <p class=\"line2\" style=\"font-size:15px;margin-top:5px;margin-bottom:45px;margin-left:10px;\"> ";
			String b =  "이보미 ";
			String c = "&#45784;&#51032;  ID&#45716; ";
			String d = "borobom ";
			String e ="&#51077;&#45768;&#45796;</p>\\r\\n\" + \r\n" + 
					...
					"</body>\\r\\n\" + \r\n" + 
					"</html>";
			helper.setText(a+b+c+d+e.replace("\r\n", ""), true);
