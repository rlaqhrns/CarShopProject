...
public interface CheckOutService {
	...
	public List<User_Tbl> userList(String u_id); //user_tbl에서 유저의 정보를 가져옴(재원/20.12.22)
	...
	public void insertBuyList(Order_Histroy_Tbl order, String u_id); //구매이력 insert(재원/20.12.22)  
