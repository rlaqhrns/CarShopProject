			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				eventClick : function(arg) {
					...
					if (confirm('이 일정을 삭제하겠습니까?')) {
						console.log("주소: " + "/calendar/delschd?u_id=<c:out value='${idcal}' />&schdtitle=" +  evttitle);
						location.replace("/calendar/delschd?u_id=<c:out value='${idcal}' />&schdtitle=" +  evttitle);
						//arg.event.remove();
					}
				},
				events : [ {
...
<!--  Modal -->
	<div class="modalc hiddenc">
		...
		<div class="modalBoxc">
			<p>모달창입니다.</p>
			<form action="/calendar/insert" method="post" id="calform">
