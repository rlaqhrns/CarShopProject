									...
									<c:forEach items="${cartList}" var="cart">
										<tr align="center">
											...
											<td>
												...
												size="1" maxlength="12" min="1" title="Quantity" value="1"
												class="cart-update" id="sst" style="float: left"> <!--  -->
											...
											<td><input type="hidden" class="product-total-amount"
												value='${cart.total}'> <fmt:formatNumber
													value="${cart.total}" pattern="#,###,###" />원</td>
									...
									<td>
										<div class="checkout_btn_inner d-flex align-items-center">
											...
											<a class="gray_btn ml-2" id="btnDelete"
												href="${path}/carshop/cart_deleteAll?u_id=${u_id}"
												onclick="showPopup()">비우기</a>
										</div>
									</td>
								</tr>
							</c:otherwise>
